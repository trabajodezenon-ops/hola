...
<head>
    ...
    <title>Dashboard de Fugas - Mapa Interactivo</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="barraPrincipal">
        <div class="container-fluid">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a class="dropdown-item active" href="mapa.php">
                                    <i class="bi bi-geo-alt me-2"></i>Mapa Interactivo
            ...
            <!-- Sección central: Filtros (SIN TIPO DE FUGA) -->
            <div class="nav-center-section">
                <div class="nav-filters">
                    ...
                    <button type="button" class="btn btn-generar-nav" id="btnGenerar">
                        <i class="bi bi-geo-alt me-1"></i>Generar Mapa
                    </button>
                </div>
            </div>
    ...
    <div class="container mt-4">
        ...
        <div id="resultados">
            <div class="alert alert-info text-center" style="background: linear-gradient(135deg, #1E3A5F 0%, #0A1F3F 100%); border: 2px solid #C1121F; color: #E0E0E0;">
                ...
                Complete los filtros y haga clic en "Generar Mapa" para visualizar los datos geográficos
            </div>
        </div>
    </div>
    ...
    <script type="module">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                mostrarAlertaGotica(`Bienvenido ${usuario || 'Usuario'} al Mapa Interactivo`, 'success');
            }, 500);
    ...
    <!-- Script específico para el mapa -->
    <script type="module" src="scriptTablero3.js"></script>
</body>
</html>