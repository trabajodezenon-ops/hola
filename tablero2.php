...
<head>
    ...
    <title>Dashboard de Fugas - Detalle</title>
    <!-- Bootstrap CSS -->
    ...
    <!-- HIGHCHARTS - CDNs alternativos -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highcharts/10.3.3/highstock.js"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highcharts/10.3.3/modules/accessibility.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highcharts/10.3.3/highcharts-3d.js"></script>
    
    <!-- ESTILOS GÓTICOS PARA ALERTAS Y MEJORAS DROPDOWN -->
    <style>
        ...
        /* Estilos para los filtros en el nav - MEJORADOS */
        .nav-filters {
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /* MEJORAS PARA EL DROPDOWN DE COLONIAS-MACROS */
        ...
        .dropdown-search-container input:focus {
            ...
            box-shadow: 0 0 8px rgba(193, 18, 31, 0.5) !important;
        ...
        .dropdown-option:hover {
            background: linear-gradient(135deg, #2A4A7F 0%, #1A3A6F 100%) !important;
            color: #FFFFFF !important;
        }

        /* Responsive para nav filters MEJORADO */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="barraPrincipal">
        <div class="container-fluid">
                ...
                <div class="nav-menu">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                <a class="dropdown-item" href="tablero.php">
                                    <i class="bi bi-bar-chart me-2"></i>General
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item active" href="tablero2.php">
                                    <i class="bi bi-bar-chart-line me-2"></i>Detalle
                                    <span class="page-indicator">Actual</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item active" href="mapa.php">
            ...
            <!-- Sección central: Filtros MEJORADOS -->
            <div class="nav-center-section">
                <div class="nav-filters">
                    ...
                    <div class="filter-group">
                        <label for="filtroColoniaMacro">
                            <i class="bi bi-geo-alt me-1"></i>Colonias-Macros
                        </label>
                        <select id="filtroColoniaMacro" name="filtroColoniaMacro" class="form-select">
                            <option value="">Todas las colonias</option>
                            <!-- Las opciones se cargarán dinámicamente desde coloniasMacros.js -->
                        </select>
                    </div>
    ...
    <script type="module">
        ...
        import { cargarColoniasMacros } from './coloniasMacros.js';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Cargar colonias y macros en el dropdown MEJORADO
            cargarColoniasMacros();
    ...
    <!-- Script específico para tablero2 -->
    <script type="module" src="scriptTablero2.js"></script>
</body>
</html>