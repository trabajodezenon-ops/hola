...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Detectar cambios en el filtro de colonias/macros
    ...
    const searchInput = document.querySelector('.dropdown-search-container input');
    if (searchInput) {
        searchInput.addEventListener('change', function() {
            console.log('Input de búsqueda cambiado:', this.value);
        });
    }
});
...
async function generarGraficasConFiltro() {
    ...
    const filtroColoniaMacro = document.getElementById('filtroColoniaMacro').value;
...
// Función global para generar gráficas (para uso desde otros scripts)
window.generarGraficasConFiltro = generarGraficasConFiltro;